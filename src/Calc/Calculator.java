...
public final class Calculator extends javax.swing.JFrame {
   ...
   public void clearRedoHistory() {
    ...
    public void addEvents() {
        ...
        // -------- Number Commands --------
        commandMap.put(btn0, new NumberCommand(this, "0"));
        commandMap.put(btn1, new NumberCommand(this, "1"));
        commandMap.put(btn2, new NumberCommand(this, "2"));
        commandMap.put(btn3, new NumberCommand(this, "3"));
        commandMap.put(btn4, new NumberCommand(this, "4"));
        commandMap.put(btn5, new NumberCommand(this, "5"));
        commandMap.put(btn6, new NumberCommand(this, "6"));
        commandMap.put(btn7, new NumberCommand(this, "7"));
        commandMap.put(btn8, new NumberCommand(this, "8"));
        commandMap.put(btn9, new NumberCommand(this, "9"));

        // -------- Operator Commands --------
        commandMap.put(btnPlus, new OperatorCommand(this, "+"));
        commandMap.put(btnSub, new OperatorCommand(this, "-"));
